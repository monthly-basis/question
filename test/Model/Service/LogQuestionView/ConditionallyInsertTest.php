<?php
namespace MonthlyBasis\QuestionTest\Model\Service\LogQuestionView;
...
class ConditionallyInsertTest extends TestCase
{
    protected function setUp(): void
    {
        ...
        $this->logQuestionViewTableMock = $this->createMock(
            QuestionTable\LogQuestionView::class
        );
        ...
        $this->conditionallyInsertService = new QuestionService\LogQuestionView\ConditionallyInsert(
            $this->memcachedServiceMock,
            $this->logQuestionViewTableMock,
