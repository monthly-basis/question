CREATE TABLE `question` (
    ...
    `image_rru_128x128` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
    `image_rru_256x256` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
    `image_rru_512x512` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
    `image_rru_1024x1024` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
